...
sinistrosRecife <- readRDS('C:\\Users\\ray_a\\OneDrive\\Documentos\\analise_de_dados\\bases_tratadas\\Sinistros Recife.rds')

sinistrosRecife <- read.csv2("C:\\Users\\ray_a\\OneDrive\\Documentos\\analise_de_dados\\bases_tratadas\\Sinistros Recife.csv", sep = ';')

microbenchmark(a <- saveRDS(sinistrosRecifeRaw, 'C:/Users/ray_a/OneDrive/Documentos/analise_de_dados/bases_tratadas/Sinistros Recife.rds'), b <- write.csv2(sinistrosRecifeRaw, 'C:\\Users\\ray_a\\OneDrive\\Documentos\\analise_de_dados\\bases_tratadas\\Sinistros Recife.csv'), times = 10L)

microbenchmark(a <- readRDS('C:\\Users\\ray_a\\OneDrive\\Documentos\\analise_de_dados\\bases_tratadas\\Sinistros Recife.rds'), b <- read.csv2("C:\\Users\\ray_a\\OneDrive\\Documentos\\analise_de_dados\\bases_tratadas\\Sinistros Recife.csv", sep = ';'), times = 10L)
